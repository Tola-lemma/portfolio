...
const Resume = (props) => {
  ...
  const applicationSkillsDetails = [
    ...
    { skill: "Checkpoint Firewall", ratingPercentage: 90 },
    { skill: "Kaspersky Antivirus", ratingPercentage: 95 },
    { skill: "Imperva WAF/DAM", ratingPercentage: 70 },
    { skill: "ManageEngine (IT Solution)", ratingPercentage: 86 },
